<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-5">
        ...
        <div>
            <label for="update_password_current_password" class="mb-1.5 block text-sm font-medium text-on-surface-secondary">{{ __('Current Password') }}</label>
        ...
        <div>
            <label for="update_password_password" class="mb-1.5 block text-sm font-medium text-on-surface-secondary">{{ __('New Password') }}</label>
        ...
        <div>
            <label for="update_password_password_confirmation" class="mb-1.5 block text-sm font-medium text-on-surface-secondary">{{ __('Confirm Password') }}</label>
