                            ...
                            <tr class="hover:bg-gray-50/50 transition">
                                ...
                                <td class="px-6 py-5 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                    ...
                                    @if($monthly->status !== 'paye')
                                        ...
                                        <button type="button" onclick="window.dispatchEvent(new CustomEvent('open-modal', {detail: 'pay-monthly-{{ $monthly->id }}'}))" class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-white bg-accent-green-500 rounded-lg hover:bg-accent-green-600 transition shadow-sm"><svg class="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2z"/></svg>Payer</button>
                                        @endcan
                                    @endif
                                    @if($monthly->status === 'paye')
