...
<div x-data="{ category: '{{ $p->category ?? 'artisan' }}' }">
    ...
    <div class="mb-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-on-surface-secondary">Nom complet <span class="text-red-500">*</span></label>
    ...
    <div class="border-t border-theme-subtle pt-5 mt-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-on-surface-secondary">Categorie <span class="text-red-500">*</span></label>
            ...
            <div x-show="category === 'autre'" x-transition>
                <label class="block text-sm font-medium text-on-surface-secondary">Categorie personnalisee <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-medium text-on-surface-secondary">Specialite</label>
                <input type="text" name="specialty" value="{{ $p->specialty }}"
                       class="mt-1.5 h-11 w-full rounded-lg border border-theme bg-transparent px-4 py-2.5 text-sm text-on-surface focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden">
            </div>

            <div>
                <label class="block text-sm font-medium text-on-surface-secondary">Entreprise</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="md:col-span-2">
                ...
                <textarea name="notes" rows="3"
                          class="mt-1.5 w-full rounded-lg border border-theme bg-transparent px-4 py-2.5 text-sm text-on-surface focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden">{{ $p->notes }}</textarea>
            </div>
            ...
            @if($provider)
                <div class="md:col-span-2 flex items-center justify-between px-1 pt-2" x-data="{ enabled: {{ $p->is_active ? 'true' : 'false' }} }">
                    ...
                    <span class="text-sm font-medium text-on-surface-secondary">Prestataire actif</span>
