...
<div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            @else
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-on-surface-secondary">SCI <span class="text-red-500">*</span></label>
            ...
            {{-- Provider --}}
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-on-surface-secondary">Prestataire <span class="text-red-500">*</span></label>
    ...
    <div class="border-t border-theme-subtle pt-5 mt-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            {{-- Title --}}
            <div class="md:col-span-2">
                <label class="block text-sm font-medium text-on-surface-secondary">Titre du contrat <span class="text-red-500">*</span></label>
    ...
    <div class="border-t border-theme-subtle pt-5 mt-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {{-- End date --}}
            <div>
                <label class="block text-sm font-medium text-on-surface-secondary">Date de fin</label>
    ...
    <div class="border-t border-theme-subtle pt-5 mt-5">
        ...
        <div>
            <label class="block text-sm font-medium text-on-surface-secondary">Description</label>
            <textarea name="description" rows="3"
                      class="mt-1.5 w-full rounded-lg border border-theme bg-transparent px-4 py-2.5 text-sm text-on-surface focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden">{{ $c->description }}</textarea>
        </div>
    </div>
