<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <!-- Password -->
        <div>
            <label for="password" class="mb-1.5 block text-sm font-medium text-on-surface-secondary">{{ __('Password') }}</label>
        ...
        <!-- Confirm Password -->
        <div>
            <label for="password_confirmation" class="mb-1.5 block text-sm font-medium text-on-surface-secondary">{{ __('Confirm Password') }}</label>
        ...
        <div class="flex items-center justify-end gap-3">
            <a class="text-sm text-on-surface-muted hover:text-on-surface-secondary transition" href="{{ route('login') }}">
